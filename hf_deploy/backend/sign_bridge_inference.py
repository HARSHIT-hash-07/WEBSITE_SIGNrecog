...
class SignBridgeInference:
    def __init__(self, model_root: str, device: str = None):
        ...
        # Paths are relative to the project root in hf_deploy
        self.vocab_path = os.path.join(PROJECT_ROOT, "model_configs", "src_vocab.txt")
        self.config_path = os.path.join(PROJECT_ROOT, "model_configs", "Sign-IDD.yaml")
